...
NICHES: list[dict] = [
    ...
    {
        "key": "sportstoriesanimated",
        "label": "SportsStoriesAnimated",
    ...
    {
        "key": "mahabharathindi",
        "label": "MahabharatHindi",
        "tagline": "Mahabharat episodes, Amar Chitra Katha, Hindi narration",
        "emoji": "🏹",
        "color_from": "from-amber-500",
        "color_to": "to-orange-700",
        "ring": "ring-amber-300/40",
        "sample_hooks": [
            "Karna ka satya pehli baar saamne aaya",
            "Eklavya ne guru-dakshina mein kya diya",
            "Krishna ne Arjun ko geeta kab sunaayi",
        ],
        "prefill": "Mujhe Mahabharat ka short banao ",
        "channel_key_for_chat": "mahabharathindi",
    },
    {
        "key": "open",
        "label": "Open prompt",
