...
class ShortProposal(BaseModel):
    ...
    # Per-channel customization knobs. Values come from the form schema in
    # pipeline/customization.py — voice, music_bed, captions_density,
    # visibility, schedule_at, plus channel-specific knobs. Renderer reads
